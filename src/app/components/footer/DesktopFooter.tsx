const DesktopFooter = () => {
  return (
    <div className="mx-6 w-11/12 h-fit px-7 py-3 rounded-3xl border border-white border-opacity-50 gap-2 flex-col justify-start items-center inline-flex">
      ...
      <div className="flex justify-between w-full">
        <div className="w-full flex flex-col grow ">
          <img
            className="w-20 h-20"
            src="https://via.placeholder.com/86x76"
            alt={"IMHO Logo"}
          ></img>
